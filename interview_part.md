https://disk.yandex.ru/i/qqiReGG4aDM8BA
...
Поток - это Последовательность данных, которая могут работать параллельно с другими своими «аналогами».

34. **Дайте определение понятию “синхронизация потоков”.**
...
Исключения, которые наследуются от RuntimeException и Error, — непроверяемые, а все остальные — проверяемые.

Нельзя скомпилировать и запустить программу, если в ней есть проверяемое исключение, которое кинули, но не обработали и не пробросили.
